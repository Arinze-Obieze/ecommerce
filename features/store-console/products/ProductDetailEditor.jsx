      ...
      {STEPS.map((step, index) => (
        <div key={step.id} className="flex items-center gap-2 min-w-max">
          <div
            className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold ${
              step.id < currentStep
                ...
                : step.id === currentStep
                ? 'border-2 border-[#2E6417] bg-white text-[#2E6417]'
          ...
          {index < STEPS.length - 1 && (
            <div className={`h-0.5 w-3 ${step.id < currentStep ? 'bg-[#2E6417]' : 'bg-gray-200'}`} />
          )}
        </div>
      ))}
    </div>
  ...
  if (isScanMode) {
    return (
      <div className="space-y-4">
        <div className="rounded-2xl border border-[#B8D4A0] bg-[#f6faf7] p-4 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#2E6417]">Scan Mode</p>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-[180px_minmax(0,1fr)]">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                <div className="rounded-xl border border-[#E8E4DC] bg-white px-3 py-2">
                    ...
                    <button
                      ...
                      className={`rounded-lg border px-3 py-1.5 text-sm font-semibold ${
                        activeSellQuantity === qty
                          ? 'border-[#2E6417] bg-[#2E6417]/10 text-[#2E6417]'
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="rounded-xl bg-[#2E6417] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#245213] disabled:opacity-50"
                >
        ...
        <details className="rounded-2xl border border-[#E8E4DC] bg-white p-4 shadow-sm">
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <Link href="/store/dashboard/products" className="text-sm font-semibold text-[#2E6417] hover:text-[#245213]">
            ← Back to products
          </Link>
      ...
      {currentStep === 1 && (
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            <button onClick={() => goToStep(2)} className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#2E6417] px-4 py-3 text-sm font-semibold text-white">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-[#E8E4DC] bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <label className="rounded-xl border border-[#2E6417] px-4 py-2 text-sm font-semibold text-[#2E6417] cursor-pointer">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => goToStep(3)} disabled={images.length === 0} className="flex-1 rounded-xl bg-[#2E6417] px-4 py-3 text-sm font-semibold text-white disabled:opacity-50">
      ...
      {currentStep === 3 && (
        <div className="space-y-6">
          <div className="rounded-2xl border border-[#E8E4DC] bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-lg border border-[#2E6417] px-3 py-2 text-xs font-semibold text-[#2E6417]"
              >
                Add spec
              </button>
            </div>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => goToStep(4)} className="flex-1 rounded-xl bg-[#2E6417] px-4 py-3 text-sm font-semibold text-white">
              Continue <FiChevronRight className="inline ml-2" size={16} />
            </button>
          </div>
        </div>
            ...
            <div className="rounded-2xl border border-[#E8E4DC] bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                <button
                  ...
                  disabled={saving}
                  className="w-full rounded-xl border border-[#2E6417] px-4 py-3 text-sm font-semibold text-[#2E6417] disabled:opacity-50"
                >
                ...
                {product.moderation_status !== 'pending_review' && product.moderation_status !== 'archived' && (
                  <button
                    ...
                    disabled={saving}
                    className="w-full rounded-xl bg-[#2E6417] px-4 py-3 text-sm font-semibold text-white hover:bg-[#245213] disabled:opacity-50"
                  >
