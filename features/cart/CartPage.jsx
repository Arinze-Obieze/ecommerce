  ...
  return (
    <div className="relative" ref={rootRef}>
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-xl border border-gray-200 bg-white px-4 py-3 text-left text-sm text-gray-900 outline-none transition focus:border-[#2E6417] disabled:bg-gray-50 disabled:text-gray-400"
      >
      ...
      {isOpen && !disabled ? (
        <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-30 overflow-hidden rounded-2xl border border-[#E8E4DC] bg-white shadow-[0_18px_40px_rgba(17,17,17,0.12)]">
          <div className="border-b border-gray-100 p-3">
            <input
              ...
              autoFocus
              className="w-full rounded-xl border border-gray-200 bg-[#f8faf8] px-3 py-2.5 text-sm outline-none focus:border-[#2E6417]"
            />
          </div>
              ...
              <>
                {allowCustom && trimmedQuery && !hasExactMatch ? (
                  ...
                  >
                    ...
                    <FiCheckCircle className="h-4 w-4 text-[#2E6417]" />
                  </button>
                ) : null}
                {filteredOptions.map((option) => (
                  <button
                    ...
                    className={`flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-left text-sm transition ${
                      option === value ? 'bg-[#EDF5E6] font-semibold text-[#1f5f43]' : 'text-gray-700 hover:bg-[#f5f8f6]'
                    }`}
                  >
                    <span>{option}</span>
                    {option === value ? <FiCheckCircle className="h-4 w-4 text-[#2E6417]" /> : null}
                  </button>
                ))}
              </>
            ) : (
                ...
                <div className="mb-5 flex flex-wrap gap-2">
                  <button
                    ...
                    className={`rounded-full px-3 py-1.5 text-xs font-semibold transition ${
                      addressMode === 'saved'
                        ? 'border border-[#B8D4A0] bg-[#EDF5E6] text-[#1f5f43]'
                    ...
                    return (
                      <button
                        ...
                        className={`w-full rounded-2xl border p-4 text-left transition ${
                          selected
                            ? 'border-[#B8D4A0] bg-[#EDF5E6]'
                            : 'border-gray-200 bg-white hover:border-[#B8D4A0]'
                        }`}
                      >
                        <div className="flex items-start justify-between gap-3">
                          ...
                          {selected ? <FiCheckCircle className="h-5 w-5 shrink-0 text-[#2E6417]" /> : null}
                        </div>
                      </button>
                    );
                  })}
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm outline-none focus:border-[#2E6417]"
                    />
                    <input
                ...
                <div className="flex-1 flex flex-col">
                  <div className="flex justify-between items-start">
                    <div>
                        ...
                        <Link href={`/products/${item.slug || item.id}`} className="text-sm md:text-base font-semibold text-gray-900 line-clamp-2 hover:text-[#2E6417] transition-colors">
                            {item.name}
                        </Link>
                        {(item.selectedColor || item.selectedSize) && (
                          <div className="mt-2 flex flex-wrap gap-2">
                            {item.selectedColor ? (
                              <span className="inline-flex items-center rounded-full bg-[#EDF5E6] px-2.5 py-1 text-[11px] md:text-xs font-semibold text-[#2E6417]">
                  ...
                  <div className="flex-1 flex flex-col justify-end mt-2 md:mt-auto">
                    ...
                    <div className="flex flex-col mb-3 md:mb-0">
                        ...
                        {pricing.hasBulkDiscount ? (
                          <span className="mt-1 text-[11px] md:text-xs font-semibold text-[#245213]">
                    ...
                    <div className="flex items-start justify-between gap-3 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          {deliverySummary && !deliveryStepOpen ? (
                            <span className="inline-flex items-center gap-1 rounded-full bg-[#EDF5E6] px-2.5 py-1 text-[11px] font-semibold text-[#1f5f43]">
                              <FiCheckCircle className="h-3.5 w-3.5" />
                              Ready
                            </span>
                          ) : null}
                          <FiMapPin className="w-4 h-4 text-[#2E6417] shrink-0 mt-0.5" />
                        </div>
                    </div>
