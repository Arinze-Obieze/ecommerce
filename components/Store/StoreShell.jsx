      ...
      <main className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <div className="mb-6 rounded-2xl border border-[#dbe7e0] bg-white px-5 py-4 shadow-sm">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#2E5C45]">Store Console</p>
              <h1 className="text-2xl font-bold text-gray-900">{storeName || 'My Store'}</h1>
              <p className="mt-1 text-sm text-gray-600">Role: {roleLabel(role)}</p>
            </div>
            <button
              type="button"
