  ...
  return (
    <div style={{
      ...
      {Array.from({length:7},(_,i)=>(
        <div key={i} style={{ position:"absolute", top:0, bottom:0, left:`${i*14.3}%`, width:1, background:"rgba(46,100,23,0.022)" }}/>
      ))}
      {/* Outer inset frame */}
      <div style={{ position:"absolute", top:"4.5%", bottom:"4.5%", left:"6%", right:"6%", border:"1px solid rgba(46,100,23,0.1)", borderRadius:2 }}/>
      {/* Inner inset frame */}
      <div style={{ position:"absolute", top:"8%",  bottom:"8%",  left:"11%", right:"11%", border:"1px solid rgba(46,100,23,0.05)", borderRadius:2 }}/>
      {/* Top recessed panel */}
      ...
      {/* Mid rail */}
      <div style={{ position:"absolute", top:"41%", left:"8%", right:"8%", height:1.5, background:"rgba(46,100,23,0.09)" }}/>
      {/* Handle */}
      <div style={{
        position:"absolute",
        ...
        borderRadius:3.5,
        border:"1px solid rgba(46,100,23,0.22)",
        display:"flex", alignItems:"center", justifyContent:"center",
      }}>
        <div style={{ width:2.5, height:22, borderRadius:1.5, background:"linear-gradient(180deg, rgba(46,100,23,0.45) 0%, rgba(46,100,23,0.85) 50%, rgba(46,100,23,0.45) 100%)", boxShadow:"0 0 5px rgba(46,100,23,0.25)" }}/>
      </div>
      {/* Edge depth shadow */}
      ...
      <div style={{ position:"absolute", top:0, bottom:0, [isLeft?"left":"right"]:0, width:2, background:"rgba(46,100,23,0.1)" }}/>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 490 125" style={{ position:"absolute", top:0, left:0, width:"100%", height:"20%", overflow:"visible" }}>
        <path d="M13,114 L13,62 Q13,-2 245,-2 Q477,-2 477,62 L477,114" fill="none" stroke="rgba(46,100,23,0.32)" strokeWidth="1.5"/>
        <path d="M0,122 L0,70 Q0,-14 245,-14 Q490,-14 490,70 L490,122" fill="none" stroke="rgba(46,100,23,0.08)" strokeWidth="1"/>
        {/* Keystone */}
        <rect x="221" y="-13" width="48" height="22" rx="2" fill="#08140A" stroke="rgba(46,100,23,0.46)" strokeWidth="1"/>
        <text x="245" y="5" textAnchor="middle" fill="rgba(46,100,23,0.65)" fontSize="7.5" fontFamily="'Helvetica Neue', sans-serif" fontWeight="800" letterSpacing="3.5">ZOVA</text>
      </svg>
      {/* Left pillar */}
...
function ProgressBar({ progress }) {
  return (
    <div style={{ position:"absolute", bottom:0, left:0, right:0, height:2, zIndex:32, background:"rgba(46,100,23,0.07)" }}>
    ...
    <div style={{
      ...
      <button type="button" onClick={onSkip}
        ...
        style={{
          ...
          background: hov ? "rgba(46,100,23,0.1)" : "transparent",
      ...
      <div style={{
        ...
        {phase >= 2 && (
          <div style={{
            ...
            background:"radial-gradient(ellipse 70% 55% at 50% 42%, rgba(46,100,23,0.09) 0%, transparent 65%)",
            animation:"fadeIn_e 1.2s ease both",
          }}/>
        )}
        {/* Floor reflection */}
        <div style={{ position:"absolute", bottom:0, left:"50%", transform:"translateX(-50%)", width:"min(490px,91vw)", height:70, zIndex:6, pointerEvents:"none", background:`linear-gradient(to top, rgba(46,100,23,${0.03 + progress * 0.07}) 0%, transparent 100%)` }}/>
