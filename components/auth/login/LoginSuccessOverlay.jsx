...
export default function LoginSuccessOverlay() {
  return (
    <div
      ...
      style={{ background: "rgba(245,241,234,0.96)", backdropFilter: "blur(16px)" }}
    >
      <div className="zova-auth-overlay-card">
        ...
        <p
          className="serif"
          style={{ fontSize: 32, fontWeight: 700, color: "var(--zova-text-strong)", margin: "0 0 8px", lineHeight: 1.1 }}
        >
          You&apos;re in!
        </p>
