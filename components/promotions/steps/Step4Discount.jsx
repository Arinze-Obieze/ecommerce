          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="e.g. 20"
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm pr-10 focus:outline-none focus:border-primary"
              />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="No cap"
                className="w-full pl-7 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-primary"
              />
            </div>
