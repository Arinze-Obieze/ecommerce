    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-[#2E5C45] resize-none"
        />
      </div>
          ...
          {usePromoCode && (
            <div>
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm font-mono focus:outline-none focus:border-[#2E5C45]"
              />
