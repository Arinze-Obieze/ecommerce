  ...
  return (
    <section style={{ padding: '2rem 0', background: '#fff' }}>
      ...
      <style>{`
        ...
        .mood-expand-btn:hover { border-color: #00B86B !important; color: #00B86B !important; }
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem', padding: '0 1rem' }}>
        ...
        <Link href="/mood" style={{ fontSize: 13, fontWeight: 500, color: '#00B86B', textDecoration: 'none' }}>
          See all moods →
        </Link>
      </div>
