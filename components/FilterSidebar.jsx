    ...
    >
      {[...Array(4)].map((_, i) => (
        <div key={i} className="animate-pulse space-y-2">
          <div className="h-3 w-20 rounded" style={{ backgroundColor: THEME.colors.softGray }} />
...
function RadioItem({ label, isActive, onClick }) {
  return (
    <button
      ...
      onMouseEnter={(e) => { if (!isActive) e.currentTarget.style.backgroundColor = THEME.colors.softGray; }}
...
function AppliedFiltersSummary({
  ...
  return (
    <div className="shrink-0 px-5 py-3 border-b" style={{ borderColor: THEME.colors.border, backgroundColor: THEME.colors.pageBg }}>
        ...
        <div className="flex items-center gap-2">
          ...
          {hasActiveFilters && (
            <span
              ...
              style={{ backgroundColor: THEME.colors.gold, color: THEME.colors.white }}
            >
              ✓
            </span>
          )}
        ...
        <div className="flex items-center gap-2">
          {hasActiveFilters && (
            <button
              ...
              style={{ backgroundColor: THEME.colors.softGray, color: THEME.colors.mediumGray, border: `1px solid ${THEME.colors.border}` }}
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#FFE4E6'; e.currentTarget.style.color = THEME.colors.saleRed; e.currentTarget.style.borderColor = '#FECDD3'; }}
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = THEME.colors.softGray; e.currentTarget.style.color = THEME.colors.mediumGray; e.currentTarget.style.borderColor = THEME.colors.border; }}
            >
          ...
          {categoriesLoading
            ...
            : <div className="space-y-2">
                ...
                {activeDepartment?.children?.length > 0 && (
                  <div className="space-y-1 pt-1 border-t" style={{ borderColor: THEME.colors.border }}>
                    <p className="px-1 pt-1 text-[10px] font-black uppercase tracking-[0.16em]" style={{ color: THEME.colors.mutedText }}>
              ...
              {['min', 'max'].map((field, i) => (
                <div key={field} className="relative flex-1">
                  ...
                  <input
                    ...
                    style={{ borderColor: THEME.colors.border, color: THEME.colors.darkCharcoal, backgroundColor: THEME.colors.pageBg }}
            ...
            {sizeOptions.map(size => {
              ...
              return (
                <button key={size} type="button" onClick={() => toggleSize(size)}
                  ...
                  onMouseLeave={(e) => { if (!isActive) { e.currentTarget.style.borderColor = THEME.colors.border;  e.currentTarget.style.color = THEME.colors.mediumGray; }}}
                >
                  {size}
                </button>
              );
              ...
              return (
                ...
                >
                  <div className="w-6 h-6 rounded-full border shadow-sm"
                    style={{ backgroundColor: color.hex, borderColor: color.hex === '#FFFFFF' ? THEME.colors.border : 'transparent' }} />
