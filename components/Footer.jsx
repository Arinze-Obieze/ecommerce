...
export default function Footer() {
  ...
  const isAuthPage = ['/login', '/signup', '/register', '/forgot-password', '/reset-password'].includes(pathname);
  ...
  return (
    <footer className="bg-white border-t border-gray-200 relative">
      {/* Newsletter Subscription Section - Prominent Placement */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-xs text-gray-600 order-2 md:order-1">
              ©2009-2026 SHEIN. All Rights Reserved.
            </div>
