...
export default function StoreDashboardOverviewPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-[#E8E4DC] bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Link
            ...
            className="rounded-xl bg-[#2E6417] px-4 py-2 text-sm font-semibold text-white hover:bg-[#245213] transition-colors"
          >
            Create Product
          </Link>
        </div>
      ...
      {loading ? (
        <div className="rounded-2xl border border-[#E8E4DC] bg-white p-6 text-sm text-gray-500">Loading store overview...</div>
      ) : null}
