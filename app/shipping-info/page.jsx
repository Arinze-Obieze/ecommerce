    ...
    <>
      <Head>
        ...
        <style>{`
          * { box-sizing: border-box; }
          ...
          @keyframes pulse {
            0%, 100% { box-shadow: 0 0 0 0 rgba(0,184,107,0.4); }
          ...
          .step-card:hover { transform: translateY(-3px); box-shadow: 0 10px 28px rgba(0,184,107,0.12) !important; }
      ...
      <div style={{ background: B.cream, minHeight: "100vh", fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(150deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, padding: "72px 24px 64px", position: "relative", overflow: "hidden" }}>
          {/* Background texture */}
          <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle, rgba(0,184,107,0.13) 1px, transparent 1px)", backgroundSize: "26px 26px" }} />
          <div style={{ position: "absolute", top: -100, right: -100, width: 400, height: 400, borderRadius: "50%", background: "rgba(0,184,107,0.1)", border: "1px solid rgba(0,184,107,0.15)" }} />
          <div style={{ position: "absolute", bottom: -60, left: -60, width: 260, height: 260, borderRadius: "50%", background: "rgba(0,184,107,0.07)" }} />

          <div style={{ position: "relative", zIndex: 1, maxWidth: 860, margin: "0 auto" }}>
            <div className="fade-up fade-up-1" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 18px", borderRadius: 20, background: "rgba(0,184,107,0.2)", border: "1px solid rgba(0,184,107,0.35)", marginBottom: 20, fontSize: 11, fontWeight: 700, color: "#7FFFC4", letterSpacing: 1.5, textTransform: "uppercase" }}>
              🚚 Shipping & Delivery
            </div>
            ...
            <div className="fade-up fade-up-3" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, maxWidth: 720 }}>
              {[
                ...
                <div key={s.label} style={{ textAlign: "center", padding: "18px 12px", background: "rgba(255,255,255,0.07)", borderRadius: 14, border: "1px solid rgba(0,184,107,0.2)" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "56px 24px 80px" }}>
          ...
          <div style={{ marginBottom: 68 }}>
            ...
            <div style={{ marginTop: 16, padding: "18px 22px", borderRadius: 14, background: `linear-gradient(135deg, ${B.greenDark}, ${B.greenMid})`, display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              <div style={{ width: 44, height: 44, borderRadius: 12, background: "rgba(0,184,107,0.25)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}>📍</div>
              ...
              <div style={{ padding: "9px 18px", borderRadius: 8, background: "rgba(0,184,107,0.25)", border: "1px solid rgba(0,184,107,0.4)", fontSize: 13, fontWeight: 700, color: "#7FFFC4", whiteSpace: "nowrap" }}>
                ₦0 — Free
              </div>
            </div>
          </div>
          ...
          <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, borderRadius: 22, padding: "52px 40px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: -50, right: -50, width: 240, height: 240, borderRadius: "50%", background: "rgba(0,184,107,0.15)" }} />
            <div style={{ position: "absolute", bottom: -30, left: -30, width: 160, height: 160, borderRadius: "50%", background: "rgba(0,184,107,0.1)" }} />
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
                <Link href="/shop" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", borderRadius: 10, background: B.green, color: B.white, fontSize: 14, fontWeight: 700, textDecoration: "none", boxShadow: "0 6px 20px rgba(0,184,107,0.4)" }}>
                  Browse All Items →
                </Link>
