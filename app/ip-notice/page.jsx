"use client";
import LegalLayout, { Section, P, Ul, InfoBox } from "../_legal/LegalLayout";
  ...
  return (
    ...
    >
      ...
      <Section title="5. Reporting Infringement" id="infringement">
        ...
        <P>Send your notice to: <a href="mailto:ip@zova.ng" style={{ color: "#00B86B", fontWeight: 600 }}>ip@zova.ng</a></P>
      ...
      <Section title="6. Takedown Process" id="dmca-equivalent">
        ...
        <P><strong>Counter-notices:</strong> If a seller believes their content was removed by mistake, they may submit a counter-notice to <a href="mailto:ip@zova.ng" style={{ color: "#00B86B", fontWeight: 600 }}>ip@zova.ng</a> including their contact details, identification of the removed content, a statement under penalty of perjury that the removal was a mistake, and their consent to jurisdiction of the relevant Nigerian court.</P>
      ...
      <Section title="8. Contact" id="contact">
        ...
        <P>For urgent matters such as large-scale counterfeiting operations, please email <a href="mailto:ip@zova.ng" style={{ color: "#00B86B", fontWeight: 600 }}>ip@zova.ng</a> and mark your email as URGENT.</P>
      </Section>
