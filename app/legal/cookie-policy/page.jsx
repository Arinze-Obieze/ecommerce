  ...
  return (
    ...
    >
      ...
      <Section title="7. Contact" id="contact">
        <P>If you have questions about our use of cookies, contact us at <a href="mailto:legal@zova.ng" style={{ color: "#00B86B", fontWeight: 600 }}>legal@zova.ng</a> or read our full <a href="/legal/privacy-policy" style={{ color: "#00B86B", fontWeight: 600 }}>Privacy Policy</a>.</P>
      </Section>
