  ...
  return (
    ...
    >
      ...
      <Section title="6. Cookies" id="cookies">
        <P>We use cookies and similar technologies to improve your experience. For full details on the cookies we use and how to manage them, see our <a href="/cookie-policy" style={{ color: "#00B86B", fontWeight: 600 }}>Cookie Policy</a>.</P>
