  ...
  return (
    <div style={{ background: B.white, borderRadius: 20, border: `1px solid ${B.greenBorder}`, overflow: "hidden" }}>
      ...
      <div style={{ background: `linear-gradient(135deg, ${B.greenDark}, ${B.greenMid})`, padding: "24px 28px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ padding: "8px 16px", borderRadius: 20, background: "rgba(0,184,107,0.25)", border: "1px solid rgba(0,184,107,0.4)", fontSize: 13, fontWeight: 700, color: "#7FFFC4" }}>
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .method-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(0,184,107,0.12); }
      ...
      <div style={{ background: B.cream, minHeight: "100vh", fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(150deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, padding: "68px 24px 60px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", top: -80, left: -80, width: 360, height: 360, borderRadius: "50%", background: "rgba(0,184,107,0.08)", border: "1px solid rgba(0,184,107,0.12)" }} />
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <div style={{ background: B.white, borderRadius: 20, border: `1px solid ${B.greenBorder}`, padding: "40px 36px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
              <a href="https://wa.me/234XXXXXXXXXX" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 26px", borderRadius: 10, background: B.green, color: B.white, fontSize: 14, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 16px rgba(0,184,107,0.35)" }}>
                📲 WhatsApp Support
              </a>
