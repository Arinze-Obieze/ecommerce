...
const STEPS = [
  {
    ...
    visual: { bg: "#F0FBF5", border: "#D4EAE0", accent: "#00B86B" },
  },
  {
    num: "02",
    icon: "📐",
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .step-btn.active { background: #00B86B !important; }
      ...
      <div style={{ background: B.cream, minHeight: "100vh", fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(150deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, padding: "68px 24px 60px", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle, rgba(0,184,107,0.12) 1px, transparent 1px)", backgroundSize: "28px 28px" }} />
          <div style={{ position: "absolute", top: -80, right: -80, width: 360, height: 360, borderRadius: "50%", background: "rgba(0,184,107,0.1)", border: "1px solid rgba(0,184,107,0.15)" }} />

          <div style={{ position: "relative", zIndex: 1, maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 18px", borderRadius: 20, background: "rgba(0,184,107,0.2)", border: "1px solid rgba(0,184,107,0.35)", marginBottom: 20, fontSize: 11, fontWeight: 700, color: "#7FFFC4", letterSpacing: 1.5, textTransform: "uppercase" }}>
              🛒 Shopping Guide
            </div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "52px 24px 80px" }}>
              ...
              <div key={activeStep} style={{ animation: "slideIn 0.3s ease both" }}>
                <div style={{ background: B.white, borderRadius: 20, border: `1px solid ${B.greenBorder}`, overflow: "hidden" }}>
                  ...
                  <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, padding: "32px 36px", position: "relative", overflow: "hidden" }}>
                    <div style={{ position: "absolute", top: -30, right: -30, width: 140, height: 140, borderRadius: "50%", background: "rgba(0,184,107,0.2)" }} />
                    <div style={{ position: "relative", zIndex: 1 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 12 }}>
                        <div style={{ width: 56, height: 56, borderRadius: 16, background: "rgba(0,184,107,0.25)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}>
                          {step.icon}
                        </div>
                        <div>
          ...
          <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, borderRadius: 20, padding: "44px 36px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: -40, right: -40, width: 200, height: 200, borderRadius: "50%", background: "rgba(0,184,107,0.15)" }} />
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
                <Link href="/shop" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 26px", borderRadius: 10, background: B.green, color: B.white, fontSize: 14, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 16px rgba(0,184,107,0.4)" }}>
                  Browse All Items →
                </Link>
