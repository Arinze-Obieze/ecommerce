      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-1 space-y-4">
            {cart.map((item) => (
              <div key={item.id} className="bg-white p-4 rounded-xl border border-gray-100 flex gap-4 transition-all hover:shadow-md">
                {/* Image */}
                ...
                <div className="flex-1 flex flex-col">
                  <div className="flex justify-between items-start">
                    <div>
                        ...
                        <Link href={`/products/${item.id}`} className="font-semibold text-gray-900 line-clamp-2 hover:text-[#2E5C45] transition-colors">
                            {item.name}
                        </Link>
                    </div>
                    <button 
