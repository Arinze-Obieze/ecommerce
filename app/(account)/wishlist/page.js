...
const SkeletonCard = ({ delay = 0 }) => (
  <div className="animate-pulse" style={{ background: '#FFFFFF', border: `1px solid ${'var(--zova-border)'}`, borderRadius: 14, overflow: 'hidden', animationDelay: `${delay}ms` }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      <main style={{ maxWidth: 1600, margin: '0 auto', padding: '40px 24px 80px' }} className="lg:px-8">
        ...
        {/* ── Page header ── */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 36, paddingBottom: 24, borderBottom: `1px solid ${'var(--zova-border)'}` }}>
          <div>
            ...
            <h1 style={{ fontSize: 28, fontWeight: 800, color: 'var(--zova-ink)', margin: 0, letterSpacing: '-0.025em', display: 'flex', alignItems: 'center', gap: 10 }}>
              Wishlist
            </h1>
          </div>

          {wishlistItems.size > 0 && (
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 100, fontSize: 13, fontWeight: 700, background: 'var(--zova-green-soft)', color: 'var(--zova-primary-action)', border: `1px solid ${'#B8D4A0'}` }}>
              <FiHeart size={13} />
        ...
        /* ── Empty state ── */
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 24px', textAlign: 'center', background: 'var(--zova-linen)', border: `1.5px dashed ${'var(--zova-border)'}`, borderRadius: 24 }}>
            <div style={{ width: 64, height: 64, borderRadius: '50%', background: 'var(--zova-green-soft)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
              <FiHeart size={26} style={{ color: 'var(--zova-primary-action)' }} />
            </div>
            <h2 style={{ fontSize: 20, fontWeight: 800, color: 'var(--zova-ink)', margin: '0 0 8px', letterSpacing: '-0.02em' }}>
              Your wishlist is empty
            </h2>
            <p style={{ fontSize: 14, color: 'var(--zova-text-muted)', margin: '0 0 28px', maxWidth: 320, lineHeight: 1.7 }}>
            ...
            <Link
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '13px 28px', borderRadius: 12, fontSize: 14, fontWeight: 700, color: '#FFFFFF', background: ctaHov ? 'var(--zova-primary-action-hover)' : 'var(--zova-primary-action)', textDecoration: 'none', transition: 'background 0.2s' }}
            >
