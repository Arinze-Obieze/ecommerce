  ...
  return (
    ...
    >
      ...
      <Section title="10. Intellectual Property" id="ip">
        ...
        <P>Sellers warrant that they own or have the right to use all content they upload. For full IP provisions, see our <a href="/ip-notice" style={{ color: "#00B86B", fontWeight: 600 }}>IP Notice</a>.</P>
      </Section>
