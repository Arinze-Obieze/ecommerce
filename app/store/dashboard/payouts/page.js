    ...
    <div className="space-y-6">
        ...
        {VIEW_OPTIONS.map((option) => (
          <button
            ...
            className={`shrink-0 rounded-xl px-4 py-2 text-sm font-semibold transition ${
              activeView === option.value ? 'bg-[#2E5C45] text-white' : 'text-gray-600 hover:bg-gray-50'
            }`}
          >
            {option.label}
          </button>
      ...
      {accountModalOpen ? (
        <div className="fixed inset-0 z-[120] flex items-end justify-center bg-black/40 p-0 sm:items-center sm:p-6">
          <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-t-2xl border border-[#dbe7e0] bg-white p-5 shadow-2xl sm:rounded-2xl">
