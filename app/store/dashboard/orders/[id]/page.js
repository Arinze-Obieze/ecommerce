...
export default function StoreOrderDetailPage() {
  ...
  if (loading) {
    return <div className="rounded-2xl border border-[#dbe7e0] bg-white p-6 text-sm text-gray-500">Loading order details...</div>;
  }
    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-[#dbe7e0] bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <Link href="/store/dashboard/orders" className="text-sm font-semibold text-[#2E5C45] hover:underline">
              Back to orders
            </Link>
