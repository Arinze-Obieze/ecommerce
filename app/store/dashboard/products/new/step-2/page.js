            ...
            <div className="space-y-3 p-4">
              ...
              {!customMode ? (
                <div className="flex gap-2">
                  ...
                  <button type="button" onClick={() => { setCustomMode(true); setCustomName(String(query || "").trim()); setCustomHex(normalizeHex(valueHex) || "#9CA3AF"); }} className="flex-1 rounded-lg border border-[#2E5C45]/30 bg-[#2E5C45]/5 px-3 py-2 text-left text-xs font-semibold text-[#2E5C45] hover:bg-[#2E5C45]/10">
                    + Add custom color
                  </button>
                </div>
              ) : (
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-3.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                ...
                className={`text-left rounded-xl border p-3 transition-colors ${!state.hasOptions ? "border-[#2E5C45] bg-[#2E5C45]/5" : "border-gray-200 bg-white hover:border-[#2E5C45]/35"}`}
              >
          ...
          <div className={`bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-3.5 ${state.hasOptions ? "lg:col-span-2" : ""}`}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                {!skuOverride ? (
                  <button type="button" onClick={() => setSkuOverride(true)} className="text-xs font-semibold text-[#2E5C45] hover:underline">Edit manually</button>
                ) : (
        ...
        {state.hasOptions && (
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
            <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-3.5 xl:col-span-8">
              ...
              <button type="button" onClick={openAddForm} className="px-3 py-2 rounded-xl border border-[#2E5C45]/35 text-[#2E5C45] text-sm font-semibold hover:bg-[#2E5C45]/5">
                + Add variant
              </button>
              ...
              {formOpen && (
                <div className="rounded-xl border border-[#dbe7e0] bg-[#f8fbf9] p-3.5 space-y-3">
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-3 space-y-2">
                    ...
                    {variantForm.useVariantMedia && (
                      <div className="space-y-2">
                        ...
                        <button type="button" onClick={() => variantUploadRef.current?.click()} className="px-3 py-1.5 rounded-lg border border-[#2E5C45]/35 text-[#2E5C45] text-xs font-semibold hover:bg-[#2E5C45]/5">
                  ...
                  <button type="button" onClick={addVariantTypeRow} disabled={variantForm.attributes.length >= ATTRIBUTE_OPTIONS.length} className="px-3 py-2 rounded-lg border border-[#2E5C45]/35 bg-white text-xs font-semibold text-[#2E5C45] hover:bg-[#2E5C45]/5 disabled:opacity-40 disabled:cursor-not-allowed">
                    + Add variant type
                  </button>
