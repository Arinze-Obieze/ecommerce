...
import { CATEGORIES, SUBCATEGORIES, AGE_GROUPS, MOODS } from "@/lib/product-wizard-constants";
import {
...
export default function Step1() {
  ...
  const fc = (f) =>
    `w-full rounded-xl border px-3 py-2.5 text-sm font-medium transition-all focus:ring-2 focus:ring-[#2E5C45]/20 focus:border-[#2E5C45] ${
  ...
  return (
    <WizardShell title="Core Details" subtitle="Select category and add your product identity details.">
      ...
      <div className="space-y-4">
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center gap-1.5 rounded-xl border-2 p-3.5 transition-all duration-200 lg:p-3 ${
                    sel ? "border-[#2E5C45] bg-[#2E5C45]/5" : "border-[#dbe7e0] bg-white hover:border-[#2E5C45]/40"
                  } ${errors.category && !sel ? "border-red-300 bg-red-50" : ""}`}
                >
                  <span className="text-2xl mb-1">{cat.icon}</span>
                  <span className={`text-xs font-bold text-center ${sel ? "text-[#2E5C45]" : "text-gray-900"}`}>
                    {cat.label}
                  </span>
                </button>
              );
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-12">
            ...
            <div className="lg:col-span-6">
              ...
              <input
                ...
                onChange={(e) => setBasicInfo("productName", e.target.value)}
              />
            ...
            <div className="lg:col-span-3">
              ...
              <input
                ...
                value={state.brand}
                onChange={(e) => setBasicInfo("brand", e.target.value)}
              />
            </div>
            ...
            {showGender && (
              <div className="lg:col-span-4">
                <label className="mb-1.5 block text-sm font-semibold text-gray-700">
                  Gender {genderRequired && <span className="text-red-400">*</span>}
                </label>
                <select
                  className={fc("gender")}
                  value={state.gender}
            ...
            {state.category === "kids" && (
              <div className="lg:col-span-4">
                ...
                <select
                  className={fc("ageGroup")}
                  value={state.ageGroup}
                  onChange={(e) => setBasicInfo("ageGroup", e.target.value)}
                >
            ...
            <div className="lg:col-span-12">
              ...
              <textarea
                ...
                placeholder="Describe the product details, fit, and important notes..."
        ...
        {/* ── MOOD TAGS ── */}
        <div className="rounded-2xl border border-[#dbe7e0] bg-white p-4 lg:p-5 space-y-3">
          <div className="flex items-center justify-between">
            ...
            {moodTags.length > 0 && (
              <span className="text-xs font-semibold text-[#2E5C45] shrink-0">
