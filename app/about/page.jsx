...
const TEAM = [
  { initials: "AO", name: "Arinze O.", role: "Founder & CEO", color: "#00B86B" },
  { initials: "CN", name: "Chioma N.", role: "Head of Quality Control", color: "#0F7A4F" },
  { initials: "EK", name: "Emeka K.", role: "Head of Seller Relations", color: "#0A3D2E" },
...
function StatCard({ val, label, animate }) {
  ...
  return (
    <div style={{ textAlign: "center", padding: "28px 20px", background: "rgba(255,255,255,0.07)", borderRadius: 16, border: "1px solid rgba(0,184,107,0.2)" }}>
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .value-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(0,184,107,0.15); }
      ...
      <div style={{ background: B.cream, minHeight: "100vh", fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(160deg, ${B.greenDark} 0%, ${B.greenMid} 60%, #1a9e5e 100%)`, padding: "80px 24px 72px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle, rgba(0,184,107,0.15) 1px, transparent 1px)", backgroundSize: "32px 32px", opacity: 0.6 }} />

          {/* Large decorative circle */}
          <div style={{ position: "absolute", top: -120, right: -120, width: 480, height: 480, borderRadius: "50%", background: "rgba(0,184,107,0.1)", border: "1px solid rgba(0,184,107,0.15)" }} />
          <div style={{ position: "absolute", bottom: -80, left: -80, width: 320, height: 320, borderRadius: "50%", background: "rgba(0,184,107,0.07)" }} />

          <div style={{ position: "relative", zIndex: 1, maxWidth: 800, margin: "0 auto", textAlign: "center" }}>

            {/* Label */}
            <div className="fade-up fade-up-1" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "7px 18px", borderRadius: 20, background: "rgba(0,184,107,0.2)", border: "1px solid rgba(0,184,107,0.35)", marginBottom: 24, fontSize: 11, fontWeight: 700, color: "#7FFFC4", letterSpacing: 1.5, textTransform: "uppercase" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "64px 24px 80px" }}>
          ...
          <div style={{ marginBottom: 72, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
            ...
            <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, borderRadius: 24, padding: 36, position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: -30, right: -30, width: 160, height: 160, borderRadius: "50%", background: "rgba(0,184,107,0.2)" }} />
          ...
          <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, borderRadius: 24, padding: "52px 40px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: -60, right: -60, width: 280, height: 280, borderRadius: "50%", background: "rgba(0,184,107,0.15)" }} />
            <div style={{ position: "absolute", bottom: -40, left: -40, width: 180, height: 180, borderRadius: "50%", background: "rgba(0,184,107,0.1)" }} />
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
                <a href="/seller" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", borderRadius: 10, background: B.green, color: B.white, fontSize: 14, fontWeight: 700, textDecoration: "none", boxShadow: `0 6px 20px rgba(0,184,107,0.4)` }}>
                  Become a Seller →
                </a>
