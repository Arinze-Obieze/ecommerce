      ...
      <div className="rounded-2xl border border-[#dbe7e0] bg-white p-5 shadow-sm">
        ...
        {summary ? (
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-5">
            <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Errors (24h): <strong>{summary.errors}</strong></div>
            <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Warnings (24h): <strong>{summary.warnings}</strong></div>
            <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Payment failures: <strong>{summary.paymentFailures}</strong></div>
            <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Rate-limit hits: <strong>{summary.rateLimitHits}</strong></div>
            <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">API p95: <strong>{summary.apiP95LatencyMs} ms</strong></div>
          </div>
        ) : null}
      </div>
