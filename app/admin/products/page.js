    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-[#dbe7e0] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-4">
          <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Total products: <strong>{rows.length}</strong></div>
          <div className="rounded-xl bg-[#f3f8f5] px-3 py-2 text-sm">Pending review: <strong>{rows.filter((p) => p.moderation_status === 'pending_review').length}</strong></div>
