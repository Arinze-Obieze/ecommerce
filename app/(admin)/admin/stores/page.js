...
const tierColor = (tier) => {
  switch (tier) {
    ...
    default: return 'bg-[#EDF5E6] text-[#2E6417] border-[#E8E4DC]';
  }
};
      ...
      <div className="mt-4 space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              className="w-full rounded-xl border border-gray-200 py-2 pl-9 pr-3 text-sm focus:border-[#2E6417] focus:outline-none focus:ring-1 focus:ring-[#2E6417]"
            ...
            <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
              {pagedSellers.map((seller) => (
                <button
                  ...
                  className="group flex flex-col gap-1.5 rounded-xl border border-gray-200 bg-white p-3 text-left shadow-sm transition-all hover:border-[#2E6417] hover:shadow-md"
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      <p className="font-bold text-gray-900 group-hover:text-[#2E6417] truncate text-sm">
  ...
  if (step === 'confirm') {
    return (
      <div className="mt-4 space-y-4">
        ...
        <div className="rounded-xl border border-[#E8E4DC] bg-[#EDF5E6] p-5 space-y-3">
          <div className="flex items-center gap-2">
            <FiCheckCircle className="h-5 w-5 text-[#2E6417]" />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="rounded-xl bg-[#2E6417] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#245213]"
          >
  ...
  if (step === 'form') {
    return (
      <div className="mt-4 space-y-4">
        ...
        <div className="rounded-xl border border-[#E8E4DC] bg-[#EDF5E6] px-4 py-2.5 text-sm text-gray-700">
          Creating store for: <span className="font-bold text-[#2E6417]">{selectedSeller.business_name}</span>{' '}
        ...
        <form onSubmit={handleCreate} className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="md:col-span-2 grid grid-cols-1 gap-1">
            ...
            <input
              className="rounded-xl border border-gray-200 px-3 py-2 text-sm focus:border-[#2E6417] focus:outline-none focus:ring-1 focus:ring-[#2E6417]"
          ...
          <div className="grid grid-cols-1 gap-1">
            ...
            <input
              className="rounded-xl border border-gray-200 px-3 py-2 text-sm font-mono focus:border-[#2E6417] focus:outline-none focus:ring-1 focus:ring-[#2E6417]"
          ...
          <div className="flex items-center">
            <label className="flex cursor-pointer items-center gap-2 rounded-xl border border-gray-200 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">
              <input
                ...
                className="h-4 w-4 rounded accent-[#2E6417]"
              />
              Payout ready
            </label>
          </div>
          ...
          <div className="md:col-span-2 flex gap-2 pt-2">
            ...
            <button
              disabled={saving}
              className="rounded-xl bg-[#2E6417] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#245213] disabled:opacity-60"
            >
    ...
    <div className="space-y-6">
            ...
            <form onSubmit={assignOwner} className="space-y-4">
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`rounded-xl border px-3 py-2 text-sm font-semibold ${assignMode === 'uuid' ? 'border-[#2E6417] bg-[#2E6417] text-white' : 'border-gray-200 text-gray-700'}`}
                >
                  Use UUID
                </button>
                <button
                  ...
                  className={`rounded-xl border px-3 py-2 text-sm font-semibold ${assignMode === 'email' ? 'border-[#2E6417] bg-[#2E6417] text-white' : 'border-gray-200 text-gray-700'}`}
                >
                  Use Email
                </button>
              </div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <button disabled={assigning} className="rounded-xl bg-[#2E6417] px-4 py-2 text-sm font-semibold text-white hover:bg-[#245213] disabled:opacity-60">
      ...
      <div className="rounded-2xl border border-[#E8E4DC] bg-white p-5 shadow-sm">
        ...
        >
          ...
          {isCreateOpen ? <FiChevronUp className="h-5 w-5 text-[#2E6417]" /> : <FiChevronDown className="h-5 w-5 text-[#2E6417]" />}
        </button>
                  ...
                  <tr key={store.id} className="border-b border-gray-50">
                    ...
                    <td className="py-2 pr-3">
                      <div className="flex flex-wrap gap-2">
                        <button className="rounded-lg border border-[#2E6417] px-2 py-1 text-xs font-semibold text-[#2E6417]" onClick={() => openAssignOwnerModal(store)}>
                          Assign owner
                        </button>
