      ...
      <form onSubmit={onSave} className="rounded-2xl border border-[#E8E4DC] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <button
            type="button"
            onClick={addRow}
            className="rounded-xl border border-[#2E6417] px-4 py-2 text-sm font-semibold text-[#2E6417]"
          >
            Add Row
          </button>
          <button
          ...
          <button
            ...
            onClick={load}
            disabled={saving}
            className="rounded-xl border border-[#2E6417] px-4 py-2 text-sm font-semibold text-[#2E6417] disabled:opacity-60"
          >
            Refresh
          </button>
        </div>
