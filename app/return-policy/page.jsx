    ...
    <>
      ...
      <div style={{ background: B.cream, minHeight: "100vh", fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div style={{ background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, padding: "64px 24px 56px", textAlign: "center", position: "relative", overflow: "hidden" }}>
          {/* decorative circles */}
          <div style={{ position: "absolute", top: -60, right: -60, width: 300, height: 300, borderRadius: "50%", background: "rgba(0,184,107,0.12)" }} />
          <div style={{ position: "absolute", bottom: -40, left: -40, width: 200, height: 200, borderRadius: "50%", background: "rgba(0,184,107,0.08)" }} />

          <div style={{ position: "relative", zIndex: 1, maxWidth: 700, margin: "0 auto" }}>
            {/* pill */}
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 18px", borderRadius: 20, background: "rgba(0,184,107,0.2)", border: "1px solid rgba(0,184,107,0.4)", marginBottom: 22, fontSize: 12, fontWeight: 700, color: "#7FFFC4", letterSpacing: 1, textTransform: "uppercase" }}>
              🛡️ Buyer Protection
            </div>
        ...
        <div style={{ maxWidth: 820, margin: "0 auto", padding: "44px 24px 64px" }}>
          ...
          <div style={{ marginBottom: 52, background: `linear-gradient(135deg, ${B.greenDark} 0%, ${B.greenMid} 100%)`, borderRadius: 20, padding: 36, position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: -50, right: -50, width: 220, height: 220, borderRadius: "50%", background: "rgba(0,184,107,0.15)" }} />
            <div style={{ position: "absolute", bottom: -30, left: -30, width: 150, height: 150, borderRadius: "50%", background: "rgba(0,184,107,0.1)" }} />
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ width: 52, height: 52, borderRadius: 14, background: "rgba(0,184,107,0.25)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, marginBottom: 16 }}>🛡️</div>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                {["4+ QC photos per item", "Unique markings documented", "Video records for high-value items"].map((t) => (
                  <span key={t} style={{ padding: "8px 16px", borderRadius: 8, background: "rgba(0,184,107,0.2)", border: "1px solid rgba(0,184,107,0.3)", fontSize: 12, fontWeight: 600, color: "#7FFFC4" }}>{t}</span>
                ))}
              </div>
            </div>
          </div>
